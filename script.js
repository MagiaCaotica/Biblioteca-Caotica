document.addEventListener('DOMContentLoaded', () => {
    ...
    function filtrarLibros() {
        ...
        librosFiltradosActuales = todosLosLibros.filter(libro => {
            // Añadir comprobaciones de tipo para mayor robustez
            const tituloLibro = typeof libro.titulo === 'string' ? libro.titulo.toLowerCase() : '';
            const autorLibro = typeof libro.autor === 'string' ? libro.autor.toLowerCase() : '';

            const coincideBusqueda = tituloLibro.includes(textoBusqueda) || autorLibro.includes(textoBusqueda);
